...
const events = {
  '01': [
    {
      title: 'Tết Nguyên Đán ở các tỉnh miền Tây',
      date: 'Tháng Giêng ÂL',
      image: 'Hình ảnh/Lễ hội/t1/tết -t1.jpg'

    },
    {
      title: 'Hội Xuân Núi Sam – Châu Đốc, An Giang',
      date: 'Mùng 10 tháng Giêng đến hết tháng 3 ÂL',
      image: 'Hình ảnh/Lễ hội/t1/via-ba -AG_ t1.jpg'

    },
    {
      title: 'Tết cổ truyền của người Hoa - Cần Thơ, Sóc Trăng',
      date: 'Sau hoặc trùng với tết Nguyên Đán',
  ...
  '02': [
    {
      title: 'Lễ hội Tống Gió(Pithi Sropreah - Sóc Trăng, Cần Thơ',
      date: 'Cuối tháng 2 ÂL',
      image: 'Hình ảnh/Lễ hội/t2/Lễ hội Tống Gió (Pithi Srôpreah) -ct, st.jpg'

    },
    {
      title: 'Lễ Cúng Miếu Ngũ Hành - Long An',
      date: 'Mùng 5–10 tháng 2 ÂL',
      image: 'Hình ảnh/Lễ hội/t2/Mieu-ba-ngu-hanh-le-cau-an _long an.jpeg'
    },
    {
      title: 'Lễ hội Nghinh Ông – Cù Lao Dung (Sóc Trăng)',
      date: '15–20 tháng 2 ÂL',
  ...
  '03': [
    {
      title: 'Lễ hội Nghinh Ông – Gành Hào, Bạc Liêu',
      date: '15–20 tháng 4 ÂL',
      image: 'Hình ảnh/Lễ hội/t3/Lễ hội Nghinh Ông – Gành Hào, Bạc Liêu.jpg'

    },
    {
      title: 'Lễ hội Nghinh ông Vàm Láng - Huyện Gò Công Đông - Tiền Giang',
      date: '10 tháng 3 ÂL',
  ...
  '04': [
    {
      title: 'Lễ hội Vía Bà Chúa Xứ (tiền lễ) – Núi Sam, An Giang (từ đầu tháng 4)',
      date: 'Tháng 4 ÂL',
      image: 'Hình ảnh/Lễ hội/t4/via-ba-Chúa Xứ -AG.png'

    },
    {
      title: 'Lễ hội đình Bình Thủy – Cần Thơ',
      date: '20–24 tháng 4 ÂLÂL',
  ...
  '05': [
    {
      title: 'Lễ kỳ yên đình thần Tân Hưng-Cà Mau',
      date: '10-11 tháng 5 ÂL',
  ...
  '06': [
    {
      title: 'Lễ hội Kỳ Yên An Thạnh - Huyện Mỏ Cày Nam, Bến Tre',
      date: '16–18 tháng 6 ÂL',
  ...
  '07': [
    {
      title: 'Lễ hội Vu Lan diễn ra khắp ở các tỉnh miền Tây',
      date: 'rằm tháng 7 ÂL',
  ...
  '09': [
    {
      title: 'Lễ Sen Dolta (tưởng niệm tổ tiên Khmer) – Sóc Trăng, Trà Vinh',
      date: '29 tháng 8 – 1 tháng 9',
  ...
  '10': [
    {
      title: 'Lễ Hội Ok om Bok - TràVinh, Sóc Trăng',
      date: 'Giữa tháng 10 ÂL',
    ...
    {
      title: 'Cúng trăng trong Lễ Hội Ok om Bok',
      date: 'Giữa tháng 10 ÂL',
  ...
  '12': [
    {
      title: 'Chợ hoa Tết – Sa Đéc, Cần Thơ',
      date: '20 tháng Chạp',
      image: 'Hình ảnh/Lễ hội/t12/8.-du-khach-tham-lang-hoa_ sa đéc tết.jpg'
    },
    {
      title: 'Hội Hoa Xuân – Chợ nổi Tết – Cái Răng, Ngã Năm',
      date: '20-25 tháng chạp',
